...
AZ_new <- AZ %>% select(Likely, location, comorbidity, education, gender, PHQ_dep,PHQ_anx, Age)
CA_new <- CA %>% select(Likely, location, comorbidity, education, gender, PHQ_dep,PHQ_anx, Age)
...
#Impact of comorbidity on likelihood - INCLUDE PHQ4 OR NO? --> NO
...
#DO I INCLUDE PHQ_DEP AND COMORBIDITY?
...
#DO I INCLUDE PHQ_ANX AND COMORBIDITY?
